...
<br>
- Practical classes are small group classes (2-3 students with 1 teacher) which focus entirely on improving your real ability to speak to improve your weekly active usage of Mandarin
<br>
- Learn faster and easier using your language to communicate to people and when you're taught vocabulary and grammar as you encounter it
<br>
- It costs AUD 9 per class or AUD 39 when included with a 1-hr private Theory class
</div>
...
We felt that there was an opportunity to help students see and most importantly, **feel** the value of language so we began to looking into more social and engaging ways for language usage which could complement the private 1-on-1 approach.

Which leads us to...The Practical Class format!

**What are Practical classes?**
<br>
Practical classes are small group classes with 2-3 students and 1 teacher focused entirely on building up the students' ability  to speak in real situations.
...
Ultimately, this format increases weekly active usage of Mandarin so you have faster progress and better retention of content.
...
Practical classes are less suited for learners who want to focus on technical vocabulary (i.e. deep medical jargon) and are already proficient conversationally unless a group can be formed with another learner who also wants to focus on the same vocabulary (case-by-case).
...
**Join now to try out 2 free classes**
<br>
